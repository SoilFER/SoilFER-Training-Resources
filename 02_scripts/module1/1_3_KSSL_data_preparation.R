...
# Check 1: Missing depth values  ===============================================
  ...
  rm(missing_depths) # Remove object
...
# Check 2: Texture validation  =================================================
  ...
  # Print rows with texture validation uncosistencies 
...
# Action 1: Summarize property in duplicated horizons by mean  =================
...
# Detect ProfID series with different top-bottom depth sequences
  ...
  # Create a function to identify continuity in horizons for each profile
  ...
  # Differentiate Profile Series in the same location
  site_lab <- site_lab %>%
...
# SECTION 8: STANDARDIZE SOIL PROPERTIES TO FIXED DEPTHS ======================
  ...
  # - Standardization uses the weighted average median to estimate values at fixed depths
  ...
  # OUTPUT: Clean data ready for digital soil mapping
    ...
    cat("\n=== STANDARDIZE DATA TO FIXED DEPTHS ===\n")
...
# Add Geographic Coordinates Back ro the data frame  ===========================
...
# Save Standardized Data =======================================================
  ...
  rm(fml) # Remove object

# Subset Standardized Data for DSM =============================================
